...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/background_cam.jpg'); ?>');">
    <div class="container">
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><?php echo anchor('browse', 'Jelajahi produk kami'); ?> dan mulailah mengorder!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
