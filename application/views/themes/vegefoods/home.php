...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_satu.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2" style="font-family: times new roman; font-size: 70px">Kami Hanya Menyewakan Peralatan Multimedia Terbaik</h1>
            <h2 class="subheading mb-4">Kualitas dan Harga Terjangkau Di Kelasnya</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_22.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2" style="font-family: times new roman; font-size: 70px">Nikmati Kemudahan Sewa Kamera Sekarang Langsung Dari Rumah</h1>
            <h2 class="subheading mb-4">Barang Dijamin Terjaga Kualitasnya</h2>
            <p><a href="#products" class="btn btn-primary">Pesan Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Sewa minimal Rp <?php echo format_rupiah(get_settings('min_shop_to_free_shipping_cost')); ?></span>
        </div>
      </div>      
    </div>
    <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Kualitas Barang Terjaga</span>
        </div>
      </div>      
    </div>
    <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/background_cam.jpg'); ?>);">
  <div class="container">
